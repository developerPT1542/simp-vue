<template>
    ...
    <div v-else>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand" href="#">FONCTION</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item ">
                  <a class="nav-link" href="#">Fonction <span class="sr-only">(current)</span></a>
                </li>
              </ul>
        ...
        <button class="btn btn-success float-end" @click="goToAddFonc">Ajouter</button>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="width: auto;">
                      <li class="d-flex justify-content-between align-items-center">
                        <router-link :to="`/user/editFonc/${user.ID}`" class="btn btn-sm btn-primary">
      ...
      computed: {
          filteredUsers() {
            return this.users.filter(user => {
              ...
              user.FUNCTIONTYPE.toLowerCase().includes(searchString)
            );});
          },
       },
      methods: {
        async fetchUsers() {
            ...
            const response = await axios.get('/api/users/fonction')
        ...
        showDeleteConfirmation(Id) {
          ...
          Swal.fire({
            ...
            axios.delete(`/api/users/deleteFonc/${Id}`)
            .then(response => {
        ...
        goToAddFonc(){
          this.$router.push({ name: 'AddFonction'}); 
        },

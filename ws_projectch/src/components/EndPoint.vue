    ...
    <div v-else>
      <div class="row">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand" href="#" >ENDPOINT</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item ">
                  <a class="nav-link" href="#">End point <span class="sr-only">(current)</span></a>
                </li>
              </ul>
         ...
         <div class="mx-auto "> 
         <button class="btn btn-success float-end" @click="goToAddEnd">Ajouter</button>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="width: auto;">
                      <li class="d-flex justify-content-between align-items-center">
                        <router-link :to="`/user/editEnd/${user.ID}`" class="btn btn-sm btn-primary">
      ...
      computed: {
        filteredUsers() {
          return this.users.filter(user => {
            ...
            (user.CERTFILE && user.CERTFILE.toLowerCase().includes(searchString))        
              );});
        },
      },
      methods: {
     ...
     'Authorization': `${localStorage.getItem('token')}`
        ...
        showDeleteConfirmation(Id) {
          ...
          Swal.fire({
            ...
            axios.delete(`/api/users/deleteend/${Id}`)
            .then(response => {

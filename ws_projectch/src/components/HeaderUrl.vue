<template>
    ...
    <div class="row">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand" href="#">HEADER URL</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item ">
                  <a class="nav-link" href="#">Header url <span class="sr-only">(current)</span></a>
                </li>
              </ul>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="width: auto;">
                      <li class="d-flex justify-content-between align-items-center">
                        <router-link :to="`/user/EditHedUrl/${user.ID}`" class="btn btn-sm btn-primary">
    ...
    filteredUsers() {
      ...
      methods: {
        async fetchUsers() {
            ...
            //     return;
            // }
            const response = await axios.get('/api/users/headerUrl');
            // , {
            //   headers: {
        ...
        showDeleteConfirmation(Id) {
          ...
          Swal.fire({
            ...
            axios.delete(`/api/users/deleteHeadUrl/${Id}`)
            .then(response => {
        ...
        goToAddHeader(){
          this.$router.push({ name: 'AddHedUrl'}); 
        },

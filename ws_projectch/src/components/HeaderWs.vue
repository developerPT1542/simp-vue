          ...
          <a class="navbar-brand" href="#">HEADER</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item ">
                  <a class="nav-link" href="#">Header <span class="sr-only">(current)</span></a>
                </li>
              </ul>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="width: auto;">
                      <li class="d-flex justify-content-between align-items-center">
                        <router-link :to="`/user/EditHeader/${user.ID}`" class="btn btn-sm btn-primary">
      ...
      methods: {
        ...
        showDeleteConfirmation(Id) {
          ...
          Swal.fire({
            ...
            axios.delete(`/api/users/deleteHeader/${Id}`)
            .then(response => {
        ...
        goToAddHeader(){
          this.$router.push({ name: 'AddHeader'}); 
        },

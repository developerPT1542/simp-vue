<template>
    ...
    <div class="row">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand" href="#">PROXIES URL</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item ">
                  <a class="nav-link" href="#">Proxies url <span class="sr-only">(current)</span></a>
                </li>
              </ul>
    ...
    filteredUsers() {
      ...
      methods: {
        async fetchUsers() {
            ...
            //     return;
            // }
            const response = await axios.get('/api/users/proxiesUrl');
            // , {
            //   headers: {
        ...
        showDeleteConfirmation(Id) {
          ...
          Swal.fire({
            ...
            axios.delete(`/api/users/deleteproxUrl/${Id}`)
            .then(response => {
        ...
        goToAddHeader(){
          this.$router.push({ name: 'AddProcUrl'}); 
        },

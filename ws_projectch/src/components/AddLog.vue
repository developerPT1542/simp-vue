    ...
    <div class="user-form text-center">
      ...
      <form @submit.prevent="createUser">
        <div class="form-group">
          ...
          <input type="text" id="exampleInputEmail1" v-model="formData.URLLINK" required>
        </div>
        <div class="form-group">
       ...
       <div class="form-group">
          ...
          <div>
            <select class="form-select" aria-label="Default select example" v-model="formData.IDENDPOINT" required>
    ...
    async fetchEndpoints() {
      ...
      async createUser() {
        try {
          ...
          const response = await axios.post('/api/users/addLog', this.formData);
          console.log('Réponse du serveur:', response.data);
          Swal.fire({
              position: 'top-end',
              icon: 'success',
              title: 'url a été ajouté',
